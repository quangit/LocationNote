 ...
 */
public class ArrayAdapterCustomMessage extends ArrayAdapter<Message> {
    List<Message> listMessage;
    Activity context;

    public ArrayAdapterCustomMessage(Activity context, List<Message> messages) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        downloadImageTask.execute(message.getAccountByIdSender());
